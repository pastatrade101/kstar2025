          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 lg:gap-12 lg:items-center">
            <div className="py-12 lg:py-20 text-center lg:text-left">
                ...
                <h1 className="text-4xl md:text-5xl font-extrabold mb-6 tracking-tight">
                  <span className="bg-gradient-to-r from-k-star-red to-k-star-blue bg-clip-text text-transparent">ClickData Tanzania</span>
                </h1>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-8">
                ...
                <div className='rounded-2xl shadow-xl overflow-hidden'>
                  <Image src="https://firebasestorage.googleapis.com/v0/b/studio-4061903538-cceaf.firebasestorage.app/o/4864%20(1).jpg?alt=media&token=2c80ae9e-65c0-45af-8f51-23580deed6f7" alt="Team analyzing data" width={800} height={600} className="w-full h-full object-cover" data-ai-hint="team data analysis"/>
                </div>
              </div>
            </div>
          </div>
